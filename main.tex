...
\acro{eugh}[CRON]{Time-based job scheduler in Unix-like systems. It automates tasks at specific intervals or dates using a special syntax with five fields: minute, hour, day of the month, month, and day of the week.}
\acro{eugh}[XMLRPC]{XML-based remote procedure call protocol for cross-platform communication.}
\acro{eugh}[MinIO]{Open-source, scalable object storage server compatible with Amazon S3, designed for cloud-native environments and on-premises deployments.}
\acro{eugh}[MongoDB]{High-performance NoSQL document database for flexible data storage and retrieval, with support for scalability, dynamic schema design, and rich query capabilities.}
\end{acronym}
%--------------------------------------------------------------
% main content
%--------------------------------------------------------------
